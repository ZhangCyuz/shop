$(function() {
        ...
        $("#submit-order").click(function() {
          location.assign('order.html?total='+$(".money-num").text());
        });
            ...
            if (response.data.length > 0) {
              ...
              for(var i = 0; i < obj.length; i++){
                ...
                $(".cart table").append('<tr class="goo">'
                  +'<td><input type="checkbox" class="chkbox"><input type="hidden" class="goods_id" value="${obj.goods_id}"></td>'
                  +'<td><img src="' + obj[i].goods_thumb + '"><br/><span>'+obj[i].goods_name +'</span></td>'
                  ...
                  +'<td class="del"><span  onclick="deleteGoods(this)">'+'删除' +'</span></td>'
                  + '</tr>');
              }
              showSum();
            }
